...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/bookmark_empty.svg
  SvgGenImage get bookmarkEmpty =>
      const SvgGenImage('assets/icons/bookmark_empty.svg');

  /// File path: assets/icons/bookmark_filled.svg
  SvgGenImage get bookmarkFilled =>
      const SvgGenImage('assets/icons/bookmark_filled.svg');
